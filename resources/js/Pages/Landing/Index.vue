<template>
  <html lang="en">
    <head>
      ...
      <link
        href="/user/assets/img/apple-touch-icon.png"
      ...
      <!-- Vendor CSS Files -->
      <link
        href="/user/assets/vendor/fontawesome-free/css/all.min.css"
        rel="stylesheet"
      />
      <link
        href="/user/assets/vendor/animate.css/animate.min.css"
        rel="stylesheet"
      />
      <link
      ...
      />
      <link
        href="/user/assets/vendor/boxicons/css/boxicons.min.css"
        rel="stylesheet"
      />
      <link
      ...
      />
      <link
        href="/user/assets/vendor/remixicon/remixicon.css"
        rel="stylesheet"
      />
      <link
        href="/user/assets/vendor/swiper/swiper-bundle.min.css"
        rel="stylesheet"
      />
    ...
    <body>
      ...
      <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
          ...
          <!-- <a href="index.html" class="logo me-auto"><img src="/user/assets/img/logo.png" alt="" class="img-fluid"></a>-->
                ...
                <div class="tab-content">
                  <div class="tab-pane active show" id="tab-1">
                    <div class="row">
                      ...
                      <div class="col-lg-4 text-center order-1 order-lg-2">
                        <img
                          src="/user/assets/img/departments-1.jpg"
                          alt=""
                          class="img-fluid"
                        />
                      </div>
                  ...
                  <div class="tab-pane" id="tab-2">
                    <div class="row">
                      ...
                      <div class="col-lg-4 text-center order-1 order-lg-2">
                        <img
                          src="/user/assets/img/departments-2.jpg"
                          alt=""
                          class="img-fluid"
                        />
                      </div>
                  ...
                  <div class="tab-pane" id="tab-3">
                    <div class="row">
                      ...
                      <div class="col-lg-4 text-center order-1 order-lg-2">
                        <img
                          src="/user/assets/img/departments-3.jpg"
                          alt=""
                          class="img-fluid"
                        />
                      </div>
                  ...
                  <div class="tab-pane" id="tab-4">
                    <div class="row">
                      ...
                      <div class="col-lg-4 text-center order-1 order-lg-2">
                        <img
                          src="/user/assets/img/departments-4.jpg"
                          alt=""
                          class="img-fluid"
                        />
                      </div>
                  ...
                  <div class="tab-pane" id="tab-5">
                    <div class="row">
                      ...
                      <div class="col-lg-4 text-center order-1 order-lg-2">
                        <img
                          src="/user/assets/img/departments-5.jpg"
                          alt=""
                          class="img-fluid"
                        />
                      </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="member d-flex align-items-start">
                  <div class="pic">
                    <img
                      src="/user/assets/img/doctors/doctors-1.jpg"
                      class="img-fluid"
                      alt=""
                    />
                  </div>
              ...
              <div class="col-lg-6 mt-4 mt-lg-0">
                <div class="member d-flex align-items-start">
                  <div class="pic">
                    <img
                      src="/user/assets/img/doctors/doctors-2.jpg"
                      class="img-fluid"
                      alt=""
                    />
                  </div>
              ...
              <div class="col-lg-6 mt-4">
                <div class="member d-flex align-items-start">
                  <div class="pic">
                    <img
                      src="/user/assets/img/doctors/doctors-3.jpg"
                      class="img-fluid"
                      alt=""
                    />
                  </div>
              ...
              <div class="col-lg-6 mt-4">
                <div class="member d-flex align-items-start">
                  <div class="pic">
                    <img
                      src="/user/assets/img/doctors/doctors-4.jpg"
                      class="img-fluid"
                      alt=""
                    />
                  </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img
                        src="/user/assets/img/testimonials/testimonials-1.jpg"
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img
                        src="/user/assets/img/testimonials/testimonials-2.jpg"
                        class="testimonial-img"
                        alt=""
                      />
                      <h3>Sara Wilsson</h3>
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img
                        src="/user/assets/img/testimonials/testimonials-3.jpg"
                        class="testimonial-img"
                        alt=""
                      />
                      <h3>Jena Karlis</h3>
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img
                        src="/user/assets/img/testimonials/testimonials-4.jpg"
                        class="testimonial-img"
                        alt=""
                      />
                      <h3>Matt Brandon</h3>
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img
                        src="/user/assets/img/testimonials/testimonials-5.jpg"
                        class="testimonial-img"
                        alt=""
                      />
                      <h3>John Larson</h3>
            ...
            <div class="row no-gutters">
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-1.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-1.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-2.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-2.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-3.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-3.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-4.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-4.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-5.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-5.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-6.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-6.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-7.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-7.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
              ...
              <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                  <a
                    href="/user/assets/img/gallery/gallery-8.jpg"
                    class="galelry-lightbox"
                  >
                    <img
                      src="/user/assets/img/gallery/gallery-8.jpg"
                      alt=""
                      class="img-fluid"
                    />
                  </a>
